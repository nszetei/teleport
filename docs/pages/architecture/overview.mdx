...
you can run both services as one binary and process.
</Notice>

### Teleport Auth Service

The auth service controls certificate authority of the cluster.
It uses managed backends and HSM to store the certificate authority private keys.
...
All public users and external services **always** connect to the proxy.
